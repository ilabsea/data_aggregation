...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/cma.css">
  ...
  <div class="container">
    <h4>
      List for Adults and Adolescents that need to be enrolled in care:
    </h4>
    <div class="row">
        <div class="col-md-12">
            <table class="table">
                ...
                <tbody>
                  ...
                  <?php if(count($record_need_enrollment_is_pregnant) <= 0){ ?>
                    <tr>
                  ...
                  ?>
                  <?php
                  foreach ($record_need_enrollment_is_pregnant as $record){
                  ?>
                  <tr class="active">
                    <td>
                    ...
                    <td>
                        <?php echo $record["vcct_code"]; ?>
                    </td>
                    <td>
                        <?php echo $record["vcct_name"]; ?>
                    </td>
                    <td>
                  ...
                  <?php if(count($record_need_enrollment_within_7) <= 0){ ?>
                    <tr>
                  ...
                  ?>
                  <?php
                  foreach ($record_need_enrollment_within_7 as $record){
                  ?>
                  <tr class="active">
                    <td>
                        <?php echo $record["case_id"]; ?>
                  ...
                  <?php if(count($record_need_enrollment_8_to_30) <= 0){ ?>
                    <tr>
                      <td colspan="5"><center><font color="red" >No Record</font></center></td>
                    </tr>
                  <?php 
                  ...
                  ?>
                  <?php
                  foreach ($record_need_enrollment_8_to_30 as $record){
                  ?>
                  <tr class="active">
                    <td>
                        <?php echo $record["case_id"]; ?>
                  ...
                  <?php if(count($record_need_enrollment_31_to_90) <= 0){ ?>
                    <tr>
                      <td colspan="5"><center><font color="red" >No Record</font></center></td>
                    </tr>
                  <?php 
                  ...
                  ?>
                  <?php
                  foreach ($record_need_enrollment_31_to_90 as $record){
                  ?>
                  <tr class="active">
                    <td>
                        <?php echo $record["case_id"]; ?>
